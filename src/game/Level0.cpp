...
bool ChatHandler::HandleServerInfoCommand(char* /*args*/)
{
    ...
    SendSysMessage("Revision ReinoDeLaOscuridad: [R167] || Conoce los ultimos cambios entrando en www.reinodelaoscuridad.com");
...
bool ChatHandler::HandleRatesCommand(char* args)
{
    ...
    PSendSysMessage(LANG_CUSTOM_RATES_XP_ESTABLISHED, plr->GetName(), new_rates);
